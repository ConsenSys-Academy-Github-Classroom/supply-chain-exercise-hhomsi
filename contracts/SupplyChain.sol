...
contract SupplyChain {
  ...
  modifier sold(uint _sku) {
    require (items[_sku].state == State.Sold , "item is already sold");
    _;
  }
  modifier shipped(uint _sku) {
    require (items[_sku].state == State.Shipped , "item is already shipped");
    _;
  }
  modifier received(uint _sku) {
    require (items[_sku].state == State.Received , "item is already received");
    _;
  }
